...
export default function LoginPage () {
  ...
  const handleLoginByMacAddress = () => {
    ...
    if(macAddress == ''){
      toast({
        title: "Uh oh! Something went wrong.", description: "Please enter the MacAddress"});
    } else {
      ...
      if(isAuthenticated){
        ...
        toast({ title: "Login Failed", description: "Invalid or Expired MacAddress.", variant: "destructive" });
      }  
    }
};
  const handleRole = () => {
  ...
  toast({
    title: "Uh oh! Something went wrong.", description: "Please enter the Username and Password"});
  } else {
  ...
  if(isAuthenticated){
    ...
    toast({ title: "Login Failed", description: "Invalid or Expired User.", variant: "destructive" });
  }  
  }
  };
          ...
          <div className="w-[400px] rounded-2xl bg-slate-900 py-4">
                <div className="flex flex-col gap-5 p-8">
                  ...
                  <label className="flex cursor-pointer items-center justify-between p-1 text-slate-400">
                    ...
                    <div className="relative inline-block" onClick={()=>{setSelectMember(!selectMember),setMethod(1)}}>
